  ...
  return (
    <Chrome><div className="wrap-narrow section">
      ...
      <div className="mt-8 flex flex-col gap-4 text-muted prose-w">
        ...
        <p><strong className="text-paper">Entrega.</strong> A confirmação do Pix é feita manualmente, em até 2 horas, das 9h às 21h — um pedido pago de madrugada é confirmado na manhã seguinte. Confirmado o recebimento, o material é liberado na sua conta e um e-mail de acesso é enviado. Se passar desse prazo, escreva para o e-mail de contato e eu resolvo na hora.</p>
