    ...
    <Chrome>
      <div className="wrap section">
        ...
        <p className="mt-6 text-muted prose-w">
          Métodos e materiais que uso nas minhas aulas. Pagamento por Pix, entrega imediata na sua conta assim que eu confirmar.
        </p>
        ...
        {products.length ? (
          ...
          <div className="mt-14">
            <Empty
              title="Os primeiros materiais estão a caminho."
              body="Enquanto isso, a mentoria individual está aberta."
